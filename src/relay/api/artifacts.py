...
the *same* audited :func:`relay.api.files.resolve_within_sandbox`
plus the shared :func:`~relay.api.files.serve_listing` /
:func:`~relay.api.files.serve_file` implementation are reused. One
...
from relay.api.files import SandboxViolation, serve_file, serve_listing
from relay.core import PauseReviewError
